...
| [**hermes-chrome-bridge**](/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-hermes-chrome-bridge) | Control authorized Chrome tabs through a local bridge. |
