...
| `project` | `project_create`, `project_list`, `project_switch`, `session_spawn` | Manage desktop [Projects](../user-guide/cli.md), or start an independent project chat without moving the caller. GUI / desktop sessions only. |
