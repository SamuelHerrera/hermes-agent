---
title: "Hermes Chrome Bridge — Control authorized Chrome tabs through a local bridge"
sidebar_label: "Hermes Chrome Bridge"
...
Control authorized Chrome tabs through a local bridge.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/hermes-chrome-bridge` |
| Path | `optional-skills/autonomous-ai-agents/hermes-chrome-bridge` |
| Version | `0.1.0` |
