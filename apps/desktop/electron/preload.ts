...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  getKeepAwake: () => ipcRenderer.invoke('hermes:keep-awake:get'),
  setKeepAwake: on => ipcRenderer.invoke('hermes:keep-awake:set', on),
  ...
  reportRendererDiagnostic: report => ipcRenderer.send('hermes:logs:renderer-diagnostic', report),
