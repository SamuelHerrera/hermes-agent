...
export const zh: Translations = {
  ...
  keybinds: {
    ...
    actions: {
      ...
      'view.screen.1': '切换到桌面 1',
      'view.screen.2': '切换到桌面 2',
      'view.screen.3': '切换到桌面 3',
      'view.screen.4': '切换到桌面 4',
      'view.screen.5': '切换到桌面 5',
  ...
  settings: {
    ...
    appearance: {
      ...
      statusPulseTitle: '实时状态动画',
      statusPulseDesc: '设置运行中会话指示器的脉动频率。较慢的频率会减少渲染和 GPU 使用。',
    ...
    mcp: {
      ...
      statusError: '错误',
      statusOff: '关闭',
      chromeBridgeConnected: 'Chrome 已连接',
      chromeBridgeDisconnected: 'Chrome 未连接',
      chromeBridgeConnectedHint: 'Hermes 可以控制已明确授权的 Chrome 配置文件。',
      chromeBridgeDisconnectedHint: '打开扩展程序弹窗并连接本机桥接。',
      chromeBridgeRefresh: '刷新',
      chromeBridgeSetup: '设置指南',
      allServers: '所有服务器',
  ...
  sidebar: {
    ...
    projects: {
      ...
      noFolders: '尚未添加文件夹。',
      recentTitle: '最近打开',
      recentHint: '从此列表移除条目不会删除项目设置。',
      recentEmpty: '没有最近打开的项目。',
      recentFailed: '无法获取最近的项目。请检查连接或在更新后重启后端。',
      removeRecent: '从最近的项目中移除',
      openRecent: '打开项目',
      addFolder: '添加文件夹',
      primaryBadge: '主',
      removeFolder: '移除',
      ...
      deleteConfirm: '从侧边栏移除此项目？重新添加相同文件夹时会恢复设置。文件和会话保持不变。',
      startWork: '新建工作树',
  ...
  prompts: {
    ...
    sudoTitle: '管理员密码',
    sudoDesc: 'Hermes 需要你的 sudo 密码来运行特权命令。密码会发送给处理此会话的后端，该后端可能位于另一台机器上。',
