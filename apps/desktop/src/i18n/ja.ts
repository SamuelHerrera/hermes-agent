...
export const ja = defineLocale({
  ...
  settings: {
    ...
    mcp: {
      ...
      statusError: 'エラー',
      statusOff: 'オフ',
      chromeBridgeConnected: 'Chrome 接続済み',
      chromeBridgeDisconnected: 'Chrome 未接続',
      chromeBridgeConnectedHint: 'Hermes は明示的に許可された Chrome プロファイルを操作できます。',
      chromeBridgeDisconnectedHint: '拡張機能のポップアップを開き、ネイティブブリッジに接続してください。',
      chromeBridgeRefresh: '更新',
      chromeBridgeSetup: 'セットアップガイド',
      allServers: 'すべてのサーバー',
  ...
  sidebar: {
    ...
    projects: {
      ...
      recentTitle: '最近開いたプロジェクト',
      recentHint: 'この一覧から削除しても、プロジェクトの設定は保持されます。',
      recentEmpty: '最近のプロジェクトはありません。',
      recentFailed: '最近のプロジェクトを取得できません。接続を確認するか、更新後にバックエンドを再起動してください。',
      removeRecent: '最近のプロジェクトから削除',
      openRecent: 'プロジェクトを開く',
      addFolder: 'フォルダを追加',
      primaryBadge: 'メイン',
      removeFolder: '削除',
      create: '作成',
