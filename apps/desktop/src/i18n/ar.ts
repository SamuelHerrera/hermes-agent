...
export const ar = defineLocale({
  ...
  keybinds: {
    ...
    actions: {
      ...
      'view.findNext': 'نتيجة البحث التالية',
      'view.findPrevious': 'نتيجة البحث السابقة',
      'view.screen.1': 'الانتقال إلى سطح المكتب 1',
      'view.screen.2': 'الانتقال إلى سطح المكتب 2',
      'view.screen.3': 'الانتقال إلى سطح المكتب 3',
      'view.screen.4': 'الانتقال إلى سطح المكتب 4',
      'view.screen.5': 'الانتقال إلى سطح المكتب 5',
  ...
  sidebar: {
    ...
    projects: {
      ...
      recentTitle: 'المشاريع المفتوحة مؤخرًا',
      recentHint: 'إزالة العناصر من هذه القائمة لا تحذف إعدادات المشروع.',
      recentEmpty: 'لا توجد مشاريع حديثة.',
      recentFailed: 'المشاريع الحديثة غير متاحة. تحقق من الاتصال أو أعد تشغيل الخادم بعد التحديث.',
      removeRecent: 'إزالة من المشاريع الحديثة',
      openRecent: 'فتح المشروع',
      ...
      deleteConfirm:
        'إزالة هذا المشروع من الشريط الجانبي؟ ستُستعاد إعداداته عند إضافة المجلد نفسه مجددًا. تبقى الملفات والجلسات دون تغيير.',
  ...
  zones: {
    ...
    moveToScreen: 'نقل إلى سطح المكتب',
    screenNumber: id => `سطح المكتب ${id}`,
