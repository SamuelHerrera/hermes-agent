...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      statusPulseTitle: '即時狀態動畫',
      statusPulseDesc: '設定執行中工作階段指示器的脈動頻率。較慢的頻率會減少繪製與 GPU 使用。',
    ...
    config: {
      ...
      keepAwakeDesc:
        '防止閒置睡眠；在 macOS 上闔蓋後仍可繼續執行。首次變更時，macOS 會要求管理員核准安裝受限的本機授權；後續變更不需要密碼。'
    },
    quickEntry: {
      enabledTitle: '快速輸入',
    ...
    mcp: {
      ...
      statusError: '錯誤',
      statusOff: '關閉',
      chromeBridgeConnected: 'Chrome 已連線',
      chromeBridgeDisconnected: 'Chrome 未連線',
      chromeBridgeConnectedHint: 'Hermes 可以控制已明確授權的 Chrome 設定檔。',
      chromeBridgeDisconnectedHint: '開啟擴充功能彈出視窗並連接原生橋接器。',
      chromeBridgeRefresh: '重新整理',
      chromeBridgeSetup: '設定指南',
      allServers: '所有伺服器',
  ...
  sidebar: {
    ...
    projects: {
      ...
      noFolders: '尚未新增資料夾。',
      recentTitle: '最近開啟',
      recentHint: '從此清單移除項目不會刪除專案設定。',
      recentEmpty: '沒有最近開啟的專案。',
      recentFailed: '無法取得最近的專案。請檢查連線或在更新後重新啟動後端。',
      removeRecent: '從最近的專案中移除',
      openRecent: '開啟專案',
      addFolder: '新增資料夾',
      primaryBadge: '主要',
      removeFolder: '移除',
      ...
      deleteConfirm: '從側邊欄移除此專案？重新新增相同資料夾時會還原設定。檔案和工作階段維持不變。',
      startWork: '新增工作樹',
