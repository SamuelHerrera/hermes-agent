      ...
      */}
      ...
      <div
        ...
        className={cn(
          ...
          'left-2.5 top-[calc(var(--titlebar-height,34px)+0.25rem)] rounded-md bg-(--ui-sidebar-surface-background)/95 shadow-[0_0_0_1px_color-mix(in_srgb,var(--ui-stroke-tertiary)_55%,transparent)] backdrop-blur-sm'
        )}
      >
        {leftToolbarTools
